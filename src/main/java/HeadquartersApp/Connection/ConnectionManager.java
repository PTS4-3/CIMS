...
public class ConnectionManager {
    ...
    /**
     * Get updates for sorted data Sends returnvalue to
     * hqController.displaySortedData()
     */
    ...
    /**
     * Get updates for the status of tasks Sends returnvalue to
     * hqController.displayTasks()
     */
    ...
    public void sendNewsItem(INewsItem item) {
        ...
        pool.execute(new Runnable() {
            ...
            @Override
            public void run() {
                new Connection(defaultIP, defaultPort).sendNewsItem(item);
            }
